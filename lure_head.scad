...
face_depth    = 4.0;            // mm, deeper cup for stronger water catch
face_cup_d    = 20.0;           // mm, cup diameter used to dish the whole nose face (reduced from 24.0 for thicker lip)
